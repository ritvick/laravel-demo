		...
		oTable = $('.dynamicTable').dataTable({
		    ...
		    "fnDrawCallback": function( oSettings ) {
				...
				if(total_page>0)
				{
					...
					//alert(no_of_page);
					var select_control="<span style='float: left;'>Page : <select onchange='jump_to_page(this.value)' class='form-control'>";
					var show_num=0;
					var selected="";
